          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           ...
           >
              ...
              <div className="space-y-6">
                 ...
                 {/* Support Section */}
                 <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-100 flex flex-col items-center text-center gap-4 mt-6">
                    <div>
                      <p className="text-xs font-black uppercase tracking-[0.2em] text-emerald-600 mb-1">Need Support?</p>
                      <h4 className="text-sm font-bold text-zinc-900">Chat with our Admin experts</h4>
                    </div>
                    <a 
                      href={`https://wa.me/${businessPhone}`} 
                      target="_blank" 
                      rel="noreferrer"
                      className="w-full py-3 bg-[#25D366] text-white rounded-xl font-black uppercase tracking-widest text-[10px] shadow-lg shadow-emerald-200 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
                    >
